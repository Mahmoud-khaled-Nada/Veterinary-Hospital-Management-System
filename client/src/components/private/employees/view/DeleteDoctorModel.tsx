...
import { deleteUserasDoctorMutation } from "../action";

interface Props {
  openModalDelete: boolean;
  setOpenModalDelete: React.Dispatch<React.SetStateAction<boolean>>;
  detetedId: number | undefined;
}

const DeleteDoctorModel: FC<Props> = ({ openModalDelete, setOpenModalDelete, detetedId }) => {
  const mutation = deleteUserasDoctorMutation();
          ...
          <div className="rounded-xl max-w-[500px] border border-gray-100 bg-white p-4">
            ...
            <div className="flex items-start gap-4 mt-6">
              <button
                ...
                onClick={() => mutation.mutateAsync(detetedId!)}
              >
                Delete
              </button>
              <button
