...
const ConfirmedDeleteModel: FC<Props> = ({ openModalDelete, setOpenModalDelete, onDelete, detetedId }) => {
  return (
    <>
      {openModalDelete && (
...
export default ConfirmedDeleteModel;
