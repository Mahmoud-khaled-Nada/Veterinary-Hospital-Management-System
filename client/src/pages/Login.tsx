...
import LoginImage from "@/__assets__/Kisses.jpg";
...
const Login = () => {
  ...
  const onSubmit: SubmitHandler<UserParams> = async (data: UserParams) => {
    ...
    <section className="relative flex flex-wrap lg:h-screen lg:items-center">
      <div className="w-full px-4 py-12 sm:px-6 sm:py-16 lg:w-1/2 lg:px-8 lg:py-24">
        <div className="mx-auto max-w-lg text-center">
          <h1 className="text-2xl font-bold sm:text-3xl">Welcome 🖐️</h1>
      ...
      <div className="relative h-64 w-full sm:h-96 lg:h-full lg:w-1/2">
        <img alt="unsplash" src={LoginImage} className="absolute inset-0 h-full w-full object-cover" />
      </div>
    </section>
  );
};
