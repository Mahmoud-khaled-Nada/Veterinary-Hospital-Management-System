...
const Login = () => {
  ...
  const mutation = useMutation({
    mutationKey: ["removeFromDoctorById"],
    mutationFn: async (data: UserLoginParams) => {
  ...
  const onSubmit: SubmitHandler<UserLoginParams> = (data: UserLoginParams) => mutation.mutateAsync(data);
  return (
    <>
